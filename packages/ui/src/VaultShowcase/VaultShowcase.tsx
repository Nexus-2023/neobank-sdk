...
import { CHAIN_CONFIG } from "../formatters"
...
function VaultShowcaseError({
  ...
  return (
    <div
      className={cn("rounded-xl border-2 border-dashed p-8", className)}
      style={{
    ...
    >
      <div className="text-center">
        ...
        {onRetry && (
          <button
            onClick={onRetry}
            className="mt-4 inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-white hover:opacity-90 transition-opacity"
            style={{
  ...
  return (
    <div className={className}>
          ...
          {showSearch && (
            <div className="relative flex-1 min-w-[200px] max-w-sm">
              ...
              <input
                ...
                className="w-full pl-9 pr-8 py-2 text-sm focus:outline-none focus:ring-2"
                style={{
                  borderRadius: "var(--raga-radius-lg)",
                  border: "1px solid var(--raga-border)",
                  backgroundColor: "var(--raga-background)",
              ...
              {searchQuery && (
                ...
                >
                  <X className="w-3 h-3" style={{ color: "var(--raga-muted-foreground)" }} />
                </button>
              )}
            </div>
          )}
      ...
      {vaults && vaults.length > 0 && (
        <p className="text-xs mb-3" style={{ color: "var(--raga-muted-foreground)" }}>
